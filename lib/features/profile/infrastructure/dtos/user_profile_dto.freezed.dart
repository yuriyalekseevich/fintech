...
mixin _$UserProfileDto {
 ...
 String get id; String get fullName; String get email; List<ProfileTransactionDto> get recentTransactions;
...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is UserProfileDto&&(identical(other.id, id) || other.id == id)&&(identical(other.fullName, fullName) || other.fullName == fullName)&&(identical(other.email, email) || other.email == email)&&const DeepCollectionEquality().equals(other.recentTransactions, recentTransactions));
}

@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,id,fullName,email,const DeepCollectionEquality().hash(recentTransactions));

@override
String toString() {
  return 'UserProfileDto(id: $id, fullName: $fullName, email: $email, recentTransactions: $recentTransactions)';
}
...
@useResult
$Res call({
 String id, String fullName, String email, List<ProfileTransactionDto> recentTransactions
});
...
/// Create a copy of UserProfileDto
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? id = null,Object? fullName = null,Object? email = null,Object? recentTransactions = null,}) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String id,  String fullName,  String email,  List<ProfileTransactionDto> recentTransactions)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _UserProfileDto() when $default != null:
return $default(_that.id,_that.fullName,_that.email,_that.recentTransactions);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String id,  String fullName,  String email,  List<ProfileTransactionDto> recentTransactions)  $default,) {final _that = this;
switch (_that) {
case _UserProfileDto():
return $default(_that.id,_that.fullName,_that.email,_that.recentTransactions);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String id,  String fullName,  String email,  List<ProfileTransactionDto> recentTransactions)?  $default,) {final _that = this;
switch (_that) {
case _UserProfileDto() when $default != null:
return $default(_that.id,_that.fullName,_that.email,_that.recentTransactions);case _:
  return null;
...
class _UserProfileDto extends UserProfileDto {
  const _UserProfileDto({required this.id, required this.fullName, required this.email, required final  List<ProfileTransactionDto> recentTransactions}): _recentTransactions = recentTransactions,super._();
  factory _UserProfileDto.fromJson(Map<String, dynamic> json) => _$UserProfileDtoFromJson(json);

@override final  String id;
@override final  String fullName;
@override final  String email;
 final  List<ProfileTransactionDto> _recentTransactions;
@override List<ProfileTransactionDto> get recentTransactions {
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _UserProfileDto&&(identical(other.id, id) || other.id == id)&&(identical(other.fullName, fullName) || other.fullName == fullName)&&(identical(other.email, email) || other.email == email)&&const DeepCollectionEquality().equals(other._recentTransactions, _recentTransactions));
}

@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,id,fullName,email,const DeepCollectionEquality().hash(_recentTransactions));
...
/// Create a copy of UserProfileDto
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? id = null,Object? fullName = null,Object? email = null,Object? recentTransactions = null,}) {
